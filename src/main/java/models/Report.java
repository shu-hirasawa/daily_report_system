...
@NamedQueries({
    ...
    @NamedQuery(
            name = JpaConst.Q_REP_GET_SERCH_MINE,
            query = JpaConst.Q_REP_GET_SERCH_MINE_DEF),
    @NamedQuery(
            name = JpaConst.Q_REP_COUNT_SERCH_MINE,
            query = JpaConst.Q_REP_COUNT_SERCH_MINE_DEF),
})
